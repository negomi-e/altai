...
const useStyles = makeStyles((theme) => ({
 ...
 function Initiatives() {
  ...
  const data = [{
    name: 'W',
    subject: 'Строительство парка',
    date: Date(),
    image: "https://i.pinimg.com/originals/5e/87/7e/5e877e528142c1f958508890cf58ad2d.jpg",
    shortText: 'Уважаемые Друзья! Предлагаю вам выбрать место для строительства парка',
    fullText: ' Предлагаю посадить больше деревьев разных видов, так же возвести фонтан для приятного время провождения. Увеличить игровую площадку для детей , добавить: качели, горку, песочницу, и прочую инфраструктуру'
  },
//   {
//     name: 'A',
...
const setOpen = () => { open = true} 
  ...
  return (
    <Container fixed className={classes.root1}>
      <Button className={classes.button}  onClick={() => setOpen()}>Добавить инициативу</Button>
